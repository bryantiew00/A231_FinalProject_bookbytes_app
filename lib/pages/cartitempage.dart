    ...
    http
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == "success") {
          ...
          total = 0.0;
          int totalItems =
              0; // Initialize a variable to store the total number of items
          ...
          print(
              "Total Number of Items: $totalItems"); // Print the total number of items
          setState(() {});
        } else {
